...
const withdrawToERC721Token = require("./functions/withdrawToERC721Token");
...
async function ERC721TokenOperations() {
    ...
    console.log("4. Withdraw ERC721 Token to any receiver address on Root chain.");
    ...
    try {
        ...
        if (choice === "4") await withdrawToERC721Token();
