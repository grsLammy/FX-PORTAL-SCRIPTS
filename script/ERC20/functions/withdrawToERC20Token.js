...
const withdrawToERC20Token = async () => {
    try {
        ...
        const tx = await fxERC20ChildTunnel.withdrawTo(childToken, receiver, amountInWEI.toString(), {
...
module.exports = withdrawToERC20Token;
